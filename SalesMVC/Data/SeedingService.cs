...
namespace SalesMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Guilherme Raduenz", "megafunk@gmail.com", new DateTime(1998, 4, 21), 33000.0, d1);
            ...
            SalesRecord r1 = new SalesRecord(1, new DateTime(2022, 05, 02), 2000.0, SaleStatus.Billed, s1);
